...
const OS_ICON_URLS: Record<string, string> = {
  ...
  'Chrome OS': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/chrome/chrome-original.svg',
...
const BROWSER_ICON_URLS: Record<string, string> = {
  ...
  'Safari': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/safari/safari-original.svg',
  'Edge': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/edge/edge-original.svg',
  'Opera': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/opera/opera-original.svg',
  'Internet Explorer': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/internetexplorer/internetexplorer-original.svg',
  'Mobile Safari': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/safari/safari-original.svg',
  'Chrome Mobile': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/chrome/chrome-original.svg',
  'Samsung Internet': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/chrome/chrome-original.svg',
  'Brave': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/chrome/chrome-original.svg',
  'Unknown': 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/devicon/devicon-original.svg',
};
...
const getBrowserIcon = (browserName: string) => {
  const iconUrl = BROWSER_ICON_URLS[browserName] || BROWSER_ICON_URLS['Unknown'];
  return (
    <img 
      src={iconUrl} 
      alt={browserName} 
