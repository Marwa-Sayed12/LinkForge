...
import { Link2, Mail, Lock, Eye, EyeOff, ArrowLeft } from "lucide-react";
...
export default function Auth() {
  ...
  // Clerk uses redirects for email/password, not custom forms
  // So we redirect to Clerk's sign-in page
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        ...
        >
          <div className="glass-card rounded-2xl p-8 space-y-6">
            ...
            {/* Email Sign-In Button - Redirects to Clerk */}
            <Button
              variant="hero"
              className="w-full"
            ...
            <div className="text-center text-sm text-muted-foreground">
              ...
              <button onClick={handleEmailSignUp} className="text-primary hover:underline">
                Create account
              </button>
            </div>
